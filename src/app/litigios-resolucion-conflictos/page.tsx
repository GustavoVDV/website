...
export default function LitigiosResolucionConflictosPage() {
  return (
        ...
        <div className="max-w-[680px] mx-auto">
          ...
          >
            <p style={{ fontSize: '1.125rem', color: '#111', borderLeft: '3px solid #111', paddingLeft: '16px', marginBottom: '28px', fontWeight: 400, lineHeight: 1.7, textAlign: 'justify' }}>
              Representamos a nuestros clientes en procesos judiciales, arbitrales y mecanismos alternativos de resolución de conflictos, ofreciendo una defensa sólida, estratégica y orientada a resultados.
            </p>
            <p style={{ fontSize: '0.9375rem', color: '#555', lineHeight: 1.85, fontWeight: 400, marginBottom: '20px', textAlign: 'justify' }}>
              Nuestra experiencia abarca controversias civiles, comerciales, contractuales y corporativas, actuando con un enfoque preventivo y eficiente que busca minimizar riesgos y proteger los intereses de cada cliente en todas las etapas del conflicto.
            </p>
            <p style={{ fontSize: '0.9375rem', color: '#555', lineHeight: 1.85, fontWeight: 400, marginBottom: 0, textAlign: 'justify' }}>
              Entendemos que cada disputa requiere una estrategia particular; por ello, analizamos cada caso con rigor jurídico y visión práctica, priorizando soluciones efectivas, negociaciones exitosas y una representación especializada ante tribunales y centros de arbitraje.
            </p>
